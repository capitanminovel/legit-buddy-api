...
body.dark {
  ...
  --muted:    #9ca3af;   /* 6.2:1 — AA */
  --border:   #1e1e1e;
  --bg:       #000000;   /* pure black */
  --white:    #111111;   /* card surface — floats over black */
  --indica:   #a78bfa;
  --sativa:   #fbbf24;
  --hybrid:   #38bdf8;
  --cbd:      #60a5fa;
...
/* ── Borderless elevation model — cards float on black via shadow only ── */
body.dark .card {
...
/* ── Mobile: 2-col, 44px touch targets ── */
